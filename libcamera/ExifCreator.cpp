...
void ExifCreator::__ExifWriteExifIFD(ExifInfoStructure *pSetExifInfo, unsigned char* pInput, unsigned char* pCurBuff, unsigned int *pOffset)
{
	...
	*pOffset += ( NUMBER_SIZE + ( NUM_EXIF_IFD * TAG_SIZE ) + OFFSET_SIZE );
	...
	// 2012.01.07 Jino.Kang Delete field of exposureTime for front Camera
	if(pSetExifInfo->exposureTime.denominator != 0)
	{
	...
	// 2012.01.07 Jino.Kang Delete field of shutterSpeed for front Camera
	if(pSetExifInfo->shutterSpeed.numerator != 0)
	{
